...
class InternalFileUpdater(FileUpdater):
    ...
    def get_updated_file_lines(self, file_name, replace_hint_entries):
    ...
    #         if hint in line:
    #             return file_lines.index(line)
    #     print("Can't find {}, the value will not be updated".format(hint))
    #     return None

    def get_updated_internal_file_lines(self, file_lines, hint_entries):
    ...
    def get_updated_readme_badges(self, file_lines, hint_entries):
        new_file_lines = file_lines
        for replace_field, hint in hint_entries.items():
    ...
    def get_lines_with_replaced_php_badges(self, file_lines, hint):
    ...
    def get_lines_with_replaced_badges(self, file_lines, hint, replace_hint):
...
updater = InternalFileUpdater('woocommerce', '3.2.2', '3.2.1', ['7.1', '7.2'],
